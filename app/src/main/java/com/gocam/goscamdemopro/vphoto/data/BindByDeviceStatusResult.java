...
import static com.gos.platform.api.result.PlatResult.PlatCmd.bindStatus;
...
public class BindByDeviceStatusResult extends PlatResult {
    private final String TAG = this.getClass().getSimpleName();

    private String message;

    public BindByDeviceStatusResult(int code, String json) {
        super(bindStatus, 0, code, json);
    }
