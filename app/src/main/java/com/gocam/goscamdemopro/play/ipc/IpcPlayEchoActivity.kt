...
class IpcPlayEchoActivity : BaseActivity<ActivityIpcPlayVideoBinding, PlayViewModel>(),
    OnDevEventCallback,
    ...
    companion object {
        ...
        fun startActivity(context: Context, devId: String) {
            val intent = Intent(context, IpcPlayEchoActivity::class.java)
    ...
    override fun onCreateData(bundle: Bundle?) {
        ...
        mMediaPlayer = GosMediaPlayer().apply {
            ...
            start(100)
            setOnDecCallBack(this@IpcPlayEchoActivity)
            setOnRecCallBack(this@IpcPlayEchoActivity)
        }
...
*/
        ...
        mBinding?.btnCloseStream?.apply {
            setOnClickListener {
                EchoUtil.destroy(this@IpcPlayEchoActivity)
                mDevice?.connection!!.stopVideo(0, this@IpcPlayEchoActivity)
            }
        }
