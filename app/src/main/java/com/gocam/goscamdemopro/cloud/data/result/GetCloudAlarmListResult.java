...
import com.gocam.goscamdemopro.cloud.data.entity.AlarmEvent;
...
public class GetCloudAlarmListResult extends PlatResult {
    protected List<AlarmEvent> data;

    public GetCloudAlarmListResult(int code, String json) {
        super(PlatCmd.getCloudAlarmList, 0, code, json);
    }
